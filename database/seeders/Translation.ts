  ...
  public async run() {
    await Translation.createMany([
      ...
      },
      {
        key: 'description',
        value:
          'La qualité de l’image ayant subi une progression fulgurante, les photographes se sont rapidement tourné vers les prises de vue extérieure. Celles-ci proposaient un nouveau challenge de taille: emporter tout le matériel du laboratoire. <br>En effet, la plaque de verre devait être traitée au moment de la prise de vue et le collodion devait rester humide. L’entièreté de leur matériel était donc nécessaire. Avec cette technologie, on se rapproche gentiment des clichés instantanés.',
        id_poi: 3,
        id_lang: 1,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'Les photographies aériennes ont longtemps été un challenge. Les premières ont été faîtes lors d’un vol en ballon par Nadar en 1858. <br>Quelques dizaines d’années plus tard, une autre idée plutôt particulière a été mise en pratique. Un appareil photo spécial pouvant être porté par des pigeons. A l’origine utilisé pour contrôler le trajet effectué par les voyageurs devant délivrer des messages. <br>Julius Neubronner élabore un second appareil : le Doppel-Sport. Une impressionnante conception pouvant prendre des photos panoramiques incurvées de 3x8cm. Tout ça grâce à un objectif tournant composé également d’un déclencheur à retardement',
        id_poi: 8,
        id_lang: 1,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'Durant toutes ces années, l’appareil photo n’a eu de cesse de s’améliorer et de révolutionner son utilisation. La plus marquante est celle liée aux téléphones portables. <br>La photographie est maintenant dans un nouveau cap: la culture de l’instant en privilégiant le temps court de la communication, promouvoir l’instantané. Maintenant encore plus particulièrement grâce aux smartphones, ce marché a presque réduit à néant le marché de l’appareil photo numérique.',
        id_poi: 9,
        id_lang: 1,
      },
      {
      ...
      */
      ...
      },
      {
        key: 'description',
        value:
          'The megalethoscope is an enlarged version of a device already existing at the time: the alethoscope. It was an optical apparatus for large-format photographic images. <br>The megalethoscope had a day effect filter and a night effect filter while allowing to view greatly enlarged images. It is accompanied by about twenty boards of about 30x40cm with various effects.',
        id_poi: 1,
        id_lang: 2,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'Famous opticians of Paris, the Chevalier family had a store containing different versions of the famous Camera Obscura. Besides, Louis-Jacques-Mandé Daguerre, fervent user of this camera in his job as a painter as well as a theater decorator, was part of their clientele. Colonel Niépce will also end up in this store because of his parent’s work. <br>All together, they contributed to a treaty concerning the official announcement of the discovery of photography in 1839.',
        id_poi: 2,
        id_lang: 2,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'This chair is part of the method of identification of recidivist criminals set up by Alphonse Bertillon. <br>This method consists of a biometric analysis accompanied by photographs of the face and profile taken under strict lighting, while being at a specific distance from the chair. It then spread throughout the world and was used to solve a good number of judicial cases.',
        id_poi: 5,
        id_lang: 2,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'The sheet film is in a different form to the original film. Instead of being in rolled form, it is in individual celluloid sheets. These sheets can either be in a frame with a capacity of 2 sheet films or in a magazine with a higher capacity. <br>This magazine is the filmpack. The advantage with this format is that they had a lighter substitute for the heavier and more fragile glass sheets.',
        id_poi: 7,
        id_lang: 2,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'Aerial photography has long been a challenge. The first ones were made during a balloon flight by Nadar in 1858. <br>A few decades later, another special idea was put into practice. A special camera that could be carried by pigeons. Originally used to monitor the route taken by travellers who had to deliver messages. <br>Julius Neubronner developed a second camera: The Doppel-Sport. An impressive design that could take curved panoramic pictures of 3x8cm. All this thanks to a revolving lens which also has a delayed shutter release.',
        id_poi: 8,
        id_lang: 2,
      },
      {
      ...
      },
      {
        key: 'description',
        value:
          'This object is called a "Wafer". It contains 3 sensors (the 3 squares), around which circuits are placed. The whole thing will then be cut up to be installed in a photographic instrument. <br>The centre square is 61.4mm long and contains 4096 lines, each with 4096 photoreceptors of 15 microns in size. The other two squares are 30.72mm and therefore have a capacity of 2048x2048 photoreceptors.',
        id_poi: 10,
        id_lang: 2,
      },
    ]);
